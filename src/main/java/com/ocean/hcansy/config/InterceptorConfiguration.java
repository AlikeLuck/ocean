...
import com.ocean.hcansy.common.interceptor.LoginInterceptor;
...
public class InterceptorConfiguration extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginInterceptor).addPathPatterns("/test/**").excludePathPatterns(interceptorPathList());
